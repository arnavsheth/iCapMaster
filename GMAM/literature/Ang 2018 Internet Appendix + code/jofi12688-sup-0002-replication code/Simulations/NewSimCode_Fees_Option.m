...
for nround=1:100 % number of times the simulation is run
...
Inv(:,81)=0;        
sum(sum(Inv));        
Div=Inv*0;CarryProv=Div;ChangeInCarryProv=Div;
